<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="" Inherits="DollarSaver.Web.Default_new" Title="DollarSaver" Codebehind="Default_new.aspx.cs" %>
...
<div class="uk-grid">
	<div class="uk-width-medium-1-2 uk-align-center">
                        ...
                        <table width="97%" cellpadding="5" cellspacing="0" class="signup_table">
                            <tr>
                                <td align="center" style="background-image:url(<%=ResolveUrl("~/images/b/topSignupBG.gif")%>);padding:5px;">
                        ...
                        <table cellpadding="10" cellspacing="0" border="0" style="width: 90%; background-image:url(<%=ResolveUrl("~/images/b/1-2-3-BG.gif")%>); background-repeat:no-repeat">
                            <tr>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" width="780px">
    <tr>
        <td align="center" valign="top">
        <!--  style="border: solid 5px #B0E060;" -->
            <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td align="center" id="subheaderCell" runat="server" style="height: 40px; font-size: 20pt; font-style: italic; font-family: Verdana, Arial; font-weight: bold; background-repeat: no-repeat; color: #FEFEFE;">
