<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" Inherits="DollarSaver.Web.Admin.OrderView" Title="DollarSaver - View Order" CodeBehind="OrderView.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:PlaceHolder ID="orderHolder" runat="server">
        ...
        <div class="row">
                    ...
                    <div class="card-content">
                        ...
                        <table class="table table-hover table-responsive">
                            ...
                            <asp:PlaceHolder ID="orderTotalHolder" runat="server">
                                <tr>
                                    <td class="text-right" colspan="4">Order Total
                                    </td>
                                    <td>
            ...
            <asp:PlaceHolder ID="returnedItemHolder" runat="server">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <h4 class="card-title">Returned Line Items</h4>
                            <table class="table table-hover table-responsive">
                                <thead>
                                    <tr>
                                        <td>Certificates</td>
                                ...
                                <asp:Repeater ID="returnedItemRepeater" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <asp:HyperLink ID="certificateLink" runat="server" />
